...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-9 w-max items-center justify-center rounded-md px-2 py-2 text-sm font-medium hover: -accent hover:text-accent-foreground focus: -accent focus:text-accent-foreground disabled:pointer-events-none disabled:opacity-50 data-[state=open]:hover: -accent data-[state=open]:text-accent-foreground data-[state=open]:focus: -accent data-[state=open]: -accent/50 focus-visible:ring-ring/50 outline-none transition-[color,box-shadow] focus-visible:ring-[3px] focus-visible:outline-1",
);
